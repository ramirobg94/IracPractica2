...
function sendData() {
  ...
  console.log("initititaatioss", isInitiator)
  if(isInitiator) sendChannel.send(data);
  else receiveChannel.send(data);
  sendTextarea.value = '';
  var dataToPrint = '<p><b>You: </b>'+data+'</p>';
  document.getElementById('chatBox').innerHTML += dataToPrint;
...
function handleMessage(event) {
  ...
  var dataToPrint = '<p><b>Remote: </b>'+event.data+'</p>';
  document.getElementById('chatBox').innerHTML += dataToPrint;
}
